const npcRoster = [
  { id: "priest", name: "祠官温烛", blurb: "守着山神祠，提到后殿就会沉默。" },
  ...
  { id: "clockmaker", name: "守钟匠石晷", blurb: "看守祠钟与木铃，记得月蚀夜每一次报时。" }
];
...
function init() {
  ...
  appendMessage(
    "system",
    "你在山路事故后被带进月隐村。入夜前，红雾封住归路，村民开始准备名为“宿狼祭”的审判宴。你必须与村民建立信任，解锁山神祠、议事谷仓与雾林旧道，拼出十二年前月蚀夜的真相。",
    "开场"
  );
